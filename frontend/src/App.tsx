...
import type { AnalyticsPayload, BootstrapPayload, ChatMessage, CreatorActionsPayload, IdeationScorePayload, NavItem, VaultPayload } from "./types";
      ...
      <div className="today-hero">
        <div>
          ...
          <div className="today-actions">
            <button className="primary" onClick={() => navigateTo("/analytics")}>Review Analytics</button>
